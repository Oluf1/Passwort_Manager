...
def load_main_menu(UI_Handler:UI_handler):#move (UI handler)
        ...
        name_label = tk.Label(UI_Handler.main_frame, text="Password Manager")
        open_vaults_button = tk.Button(
            UI_Handler.main_frame,
            text="Vaults",
            bg="royalblue",
        ...
        config_button = tk.Button(
            UI_Handler.main_frame, text="config", bg="lightgrey", command=UI_Handler.load_config
        )
        ...
        UI_Handler.root.after(10, lambda: UI_Handler.Font_Manager.apply_fonts(UI_Handler.main_frame))